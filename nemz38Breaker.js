...
function startGame() {
	...
	document.getElementById('legion1').style.display = 'none';
	document.getElementById('legion2').style.display = 'none';
    ...
    var gameOverSounds = ['gameOver.mp3', 'gameOver2.mp3', 'gameOver3.mp3'];

    var imageRadius = 25;
	var ballImage = new Image();
	ballImage.src = 'ballImage.png';
    ...
    function drawBall() {
		ctx.beginPath();
		ctx.arc(x, y, imageRadius, 0, Math.PI * 2);  // Here use imageRadius instead of ballRadius
		ctx.closePath();
		ctx.drawImage(ballImage, x - imageRadius, y - imageRadius, imageRadius * 2, imageRadius * 2); // Draw the image centered at the ball's position
	}
